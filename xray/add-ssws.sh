...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/anggradiantoro/bgssc/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS raw.githubusercontent.com/anggradiantoro/bgssc/main/main/allow | grep $MYIP | awk '{print $2}')
