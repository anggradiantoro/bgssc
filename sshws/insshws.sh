...
#wget -O /etc/systemd/system/ws-openssh.service https://raw.githubusercontent.com/anggradiantoro/bgssc/main/sshws/service-wsopenssh && chmod +x /etc/systemd/system/ws-openssh.service

#System Dropbear Websocket-SSH Python
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/anggradiantoro/bgssc/main/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/anggradiantoro/bgssc/main/sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
